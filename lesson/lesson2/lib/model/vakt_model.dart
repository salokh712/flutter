...
NamozModel namozModelFromJson(String str) => NamozModel.fromJson(json.decode(str));

String namozModelToJson(NamozModel data) => json.encode(data.toJson());
...
class NamozModel {
    ...
    factory NamozModel.fromJson(Map<String, dynamic> json) => NamozModel(
